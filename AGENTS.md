...
This project is indexed by GitNexus as **10x** (10943 symbols, 47805 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
